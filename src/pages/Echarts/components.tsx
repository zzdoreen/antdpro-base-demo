...
const ChartComponent = ({ refs, option }: { refs: RefObject<HTMLElement>, option: string }) => {
    return <>
        {/* @ts-ignore */}
        <div className="charts" ref={refs} />
        <Collapse>
            <Collapse.Panel key='1' header={<HeaderComponent opts={option} />}>
...
export const BarChart = () => {
    ...
    return <ChartComponent refs={barRef} option={barOption} />
}
...
export const PieChart = () => {
    ...
    return <ChartComponent refs={pieRef} option={pieOption} />
}
...
export const DatasetChart = () => {
    ...
    return <ChartComponent refs={datasetRef} option={datasetOption} />
}